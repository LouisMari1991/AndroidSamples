...
import com.sync.architecture.blueprints.todoapp.data.source.local.TasksPersistenceContract.TaskEntry;
...
@Singleton public class TasksLocalDataSource implements TasksDataSource {
  ...
  @Inject public TasksLocalDataSource(@NonNull Context context) {
