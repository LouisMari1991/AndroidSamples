...
import static com.sync.scrollshapeui.utils.StatusBarUtil.getStatusBarHeight;
...
public class NeteasePlaylistActivity2 extends AppCompatActivity {
  ...
  private void setImgHeaderBg() {
    Glide.with(this).load(NeteasePlaylistActivity2.IMAGE_URL_MEDIUM)
        //                .placeholder(R.drawable.stackblur_default)
  ...
  public static void start(Activity context, ImageView imageView, boolean isRecyclerView) {
    Intent intent = new Intent(context, NeteasePlaylistActivity2.class);
